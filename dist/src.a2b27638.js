...
function generateRandom() {
  var minimum = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  var maximum = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10 * 10 * 1;
  var diff = maximum - minimum;
  var randomsan = Math.random();
...
function addBombs(bombCount) {
  ...
  while (currentBombCount) {
    var x = (0, _getRandom.generateRandom)(100 - 100, matrixWidth - 2 + 1);
    var y = (0, _getRandom.generateRandom)(100 - 100, matrixHeight - 2 + 1);
